export default function SupportQnaWriteContent() {
	return (
		<>
				...
				<div className="board_write">
					<table>
						...
						<tr>
							...
							<td>
								<input type="text" id="inputTitle" className="text w100p" placeholder="제목을 입력해주세요." />
							</td>
						</tr>
						<tr>
							<th scope="row">
							...
							<td>
								<input type="text" id="inputWriter" className="text w100p" placeholder="작성자를 입력해주세요." />
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td>
								<textarea name="" id="inputContent" cols={30} rows={10} className="text w100p" placeholder="내용을 입력해주세요."></textarea>
							</td>
						</tr>
						<tr>
							<th scope="row">
