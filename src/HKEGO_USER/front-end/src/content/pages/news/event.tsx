	...
	return (
		<>
			<section className="board_wrap inner" aria-labelledby="page-title">
				...
				<ul className="gallery_basic type_small">
					<li>
						<a href="/news/event_view">
							<span className="imgfit">
								<img src="/pub/images/img_sample_event.webp" alt="" />
							</span>
							<span className="txt">
								<h3 className="tit">
									{"제8기 시민참여예산위원회 위원 공개모집"}
								</h3>
								<span className="date">
					...
					<li>
						<a href="/news/event_view">
							<span className="imgfit">
								<img src="/pub/images/no_image.svg" alt="" />
							</span>
							<span className="txt">
								<h3 className="tit">
									{"제8기 시민참여예산위원회 위원 공개모집"}
