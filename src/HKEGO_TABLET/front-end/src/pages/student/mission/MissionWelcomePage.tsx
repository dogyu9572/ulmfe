	...
	return (
		<main className="container flex_center" id="mainContent">
			...
			<section className="basic_board welcome_wrap">
				...
				<ol className="activity_order_step_area grid grid_slice6">
					<li><i aria-hidden="true"><img src={pubUrl("/pub/images/icon_activity_order01.webp")} alt="" /></i><strong>스토리 제시</strong></li>
