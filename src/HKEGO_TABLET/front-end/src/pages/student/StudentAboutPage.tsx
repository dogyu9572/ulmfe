...
export const StudentAboutPage = () => {
	...
	return (
		<main className="container flex_center" id="mainContent">
			<h1 className="sound_only">사건탐구 프로그램 안내</h1>
				...
				<div className="inbox">
					...
					<div className="case_investigation_btm type1">
						...
						<div className="right">
							...
							}}><strong>사건탐구 시작하기</strong><p>첫번째 활동으로 떠나볼까요?<img src={pubUrl("/pub/images/btn_link_search.webp")} alt="" aria-hidden="true" /></p></a>
						</div>
					</div>
				</div>
			</section>
