		...
		<main className="container flex_center" id="mainContent">
			...
			<section className="basic_board welcome_wrap">
				...
				<ol className="activity_order_step_area">
					...
					<li><i aria-hidden="true"><img src="/pub/images/icon_activity_order02.webp" alt="" /></i><strong>퀘스트1</strong><p>2층 ESD 배움터 아이디어실 1</p></li>
					<li><i aria-hidden="true"><img src="/pub/images/icon_activity_order03.webp" alt="" /></i><strong>퀘스트2</strong><p>1층 ESD 체험터 사회존</p></li>
					<li><i aria-hidden="true"><img src="/pub/images/icon_activity_order04.webp" alt="" /></i><strong>퀘스트3</strong><p>1층 ESD 체험터 사회존</p></li>
					<li><i aria-hidden="true"><img src="/pub/images/icon_activity_order05.webp" alt="" /></i><strong>퀘스트4</strong><p>1층 미디어실</p></li>
