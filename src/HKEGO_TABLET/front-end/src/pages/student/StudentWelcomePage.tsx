...
const caseActivityOrderIconSrc = (index: number) => pubUrl(`/pub/images/icon_activity_order0${index + 2}.webp`)
...
export const StudentWelcomePage = () => {
	...
	return (
		<main className="container flex_center" id="mainContent">
			<h1 className="sound_only">참석 환영 및 오늘의 활동 순서</h1>
			...
			<section className="basic_board welcome_wrap">
				...
				<ol className="activity_order_step_area case_activity_order_step_area">
					<li><i aria-hidden="true"><img src={pubUrl("/pub/images/icon_activity_order01.webp")} alt="" /></i><strong>사건제시</strong><p>{introPlace}</p></li>
					...
					<li><i aria-hidden="true"><img src={pubUrl("/pub/images/icon_activity_order06.webp")} alt="" /></i><strong>정리 및 일반화</strong><p>{summaryStep?.place || summaryStep?.title || ''}</p></li>
				</ol>
