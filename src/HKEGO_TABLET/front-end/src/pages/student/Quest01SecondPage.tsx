...
export const Quest01SecondPage = () => {
	...
	const { content, questions, savedAnswers, title, location, stepLabel } = useQuestDynamicPage(0, 1)
	const { pageRef, submit, saving, restoreSavedAnswers } = useQuestSubmit({ routeIndex: 0, nextPath: '/student/quest01_3' })
