			...
			<section className="basic_board">
				<div className="page_end quest_end02">
					<div className="tit_area flex_center colm">
						<h2 className="end_tit">퀘스트2 수행 완료!</h2>
						<p>산업, 경제, 역사, 문화가 살아 숨 쉬는<br /><strong>울산의 소중하고 아름다운 대표 자원들</strong>을 알아보았어요.</p>
					</div>
					...
					<div className="next_page_qr">
						...
						<button className="btn_qr flex_center" onClick={() => navigate('/student/quest03')}>QR 스캔하기</button>
