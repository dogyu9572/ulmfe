...
export const teacherResources = [
	{ type: 'document', label: '문서', title: '사건탐구 교사용 지도안', text: '전체 프로그램 운영 가이드 및 단계별 진행 방법', href: pubUrl('/pub/pdf/sample_document.pdf'), button: '다운로드' },
	{ type: 'document', label: '문서', title: 'SDGs 교육 자료', text: '지속가능발전목표 관련 교육 참고 자료', href: pubUrl('/pub/pdf/sample_document.pdf'), button: '다운로드' },
	...
	{ type: 'document', label: '문서', title: '활동지 양식 ', text: '사건탐구 퀘스트 활동지', href: pubUrl('/pub/pdf/sample_document.pdf'), button: '다운로드' },
	{ type: 'document', label: '문서', title: '평가지 양식', text: '사건탐구 평가지', href: pubUrl('/pub/pdf/sample_document.pdf'), button: '다운로드' },
	{ type: 'document', label: '문서', title: '설문지 양식', text: '사건탐구 설문지', href: pubUrl('/pub/pdf/sample_document.pdf'), button: '다운로드' }
]
